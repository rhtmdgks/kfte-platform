...
export default function NewEventArchivePage() {
  return (
    <div className="flex flex-col">
      <header className="flex h-14 items-center gap-4 border-b px-6">
        ...
        <h1 className="text-lg font-semibold text-[#002065]">새 행사 아카이브</h1>
      </header>
      <main className="flex-1 p-6">
        <ContentPostForm contentType="event_archive" action={createPost} />
      </main>
    </div>
  )
}
